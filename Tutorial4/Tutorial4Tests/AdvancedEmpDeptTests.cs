...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = (from e in emps orderby e.HireDate ascending select e).Take(2).ToList(); 
    ...
    public void ShouldReturnDistinctJobTitles()
    {
        ...
        var jobs = (from e in emps select e.Job).Distinct() ; 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        var emps = Database.GetEmps();
         ...
         var result = from e in emps where e.Sal > 500 select e; 
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        var emps = Database.GetEmps();
         ...
         var result = from e in emps where e.Comm > 400 select e; 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        var emps = Database.GetEmps();
         ...
         var result = from e1 in emps join e2 in emps on e1.Mgr equals e2.EmpNo select new {Employee = e1.EName, Manager = e2.EName};
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = from e in emps select new {EName = e.EName , Total = (e.Sal + e.Comm??0 )}; 
